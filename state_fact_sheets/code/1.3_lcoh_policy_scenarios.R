...
# LCOH
state_lcoh_summary <- combined_policy_df %>% 
...
county_lcoh_summary <- combined_policy_df %>% 
...
#### DATA EXPORT ####
writexl::write_xlsx(combined_policy_df, "state_fact_sheets/data/modified/state-data/MN/250815_facility_lcoh_results_mn.xlsx") 
...
writexl::write_xlsx(county_emissions_summary, "state_fact_sheets/data/modified/state-data/MN/250815_county_emissions_results_mn_v3.xlsx")
writexl::write_xlsx(county_lcoh_summary, "state_fact_sheets/data/modified/state-data/MN/250815_county_lcoh_results_mn_v3.xlsx")

writexl::write_xlsx(state_emissions_summary, "state_fact_sheets/data/modified/state-data/MN/250815_state_emissions_results_mn_v3.xlsx")
writexl::write_xlsx(state_lcoh_summary, "state_fact_sheets/data/modified/state-data/MN/250815_state_lcoh_results_mn_v3.xlsx")

writexl::write_xlsx(tech_combined_df, "state_fact_sheets/data/modified/state-data/MN/250811_facility_option_b_sample_mn_v3.xlsx")
