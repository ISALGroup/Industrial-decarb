...
params = [ {'type' : 'flow', 'name' : 'Market pulp (Pulper)',
                  'attribute': 'mass_flow_rate', 'min':50, 'max': 10000,
                  'default': 1000},
          {'type' : 'unit', 'name' : 'Stock preparation',
           'attribute': 'coefficient',
           'coefficient_name' : 'Energy consumption per ton of paper',
           'min':0.3, 'max': 1.5, 'default': 0.7}]
...
objectives = {'y1' : {'type' : 'flow', 'name' : 'Steam (Stock preparation)',
                      'attribute' : 'heat_flow_rate', 'value' : 800000},
              'y2' : {'type' : 'flow', 'name' : 'Dried paper',
                                    'attribute' : 'mass_flow_rate', 'value' : 900}}
...
### Define the archetypes results according to parameters
    ...
    ### To extend to multiple objectives?
        ...
        #        print(flowindex)
                ...
                #print(y_attr)
                delta = abs(y_attr - objectives[objective_name]['value'])
