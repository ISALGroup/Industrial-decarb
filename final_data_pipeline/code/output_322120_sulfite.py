...
kraft_process_units = pd.read_excel('data/322120_sulfite_process_parameters.xlsx', sheet_name= 'unit heat demand')
kraft_combustion_units = pd.read_excel('data/322120_sulfite_process_parameters.xlsx', sheet_name= 'unit types')
kraft_non_electrifiable_fuels = pd.read_excel('data/322120_sulfite_process_parameters.xlsx', sheet_name= 'non electrifiable fuels')


#Load data
unit_emissions = pd.read_excel('data/Facility_and_Unit_Emissions_Database_2023_v4.xlsx', sheet_name= 'unit_emissions')
unit_emissions = unit_emissions[unit_emissions['primary_naics'] == 322120]
...
facility_info = facility_info[facility_info['primary_naics'] == 322120]
...
kraft_filtered_df = combustion_unit_correspondence[combustion_unit_correspondence['plant type'] == 'sulfite']
...
electrification_df.to_excel('output/322120_sulfite_longform.xlsx')
...
sorted_elec_df.to_excel('output/322120_sulfite_elec.xlsx')
...
no_whp_df.to_excel('output/322120_sulfite_elec_nowhp.xlsx')
