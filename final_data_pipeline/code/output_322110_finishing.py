...
kraft_process_units = pd.read_excel('data/322110_finishing_process_parameters.xlsx', sheet_name= 'unit heat demand')
kraft_combustion_units = pd.read_excel('data/322110_finishing_process_parameters.xlsx', sheet_name= 'unit types')
kraft_non_electrifiable_fuels = pd.read_excel('data/322110_finishing_process_parameters.xlsx', sheet_name= 'non electrifiable fuels')
...
sorted_elec_df.to_excel('output/322110_finishing_elec.xlsx')
...
no_whp_df.to_excel('output/322110_finishing_elec_nowhp.xlsx')
