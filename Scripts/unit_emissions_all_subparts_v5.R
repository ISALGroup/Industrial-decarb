...
#           _v4: add naics_code 311230
#           _v5: use v4 of unit level dataset
# 
# Inputs:   
#         
#
...
subpart_c = read_csv("/Users/Ben L/Documents/UCSB Bren/Research/2035 Initiative Industrial Decarbonization/Plant and Unit Level Dataset/Output/subpart_c_emissions_and_fuel_by_unit_v4.csv") |>
  rename(ghg_name = "ghg_gas_name")
