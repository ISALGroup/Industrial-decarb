...
os.chdir('C:/Users/Antoine/Documents/GitHub/Industrial-decarb/generic_heat_repartition')
...
myprocess_units = pd.read_excel('data/325193_process_parameters.xlsx', sheet_name= 'unit heat demand')
myprocess_combustion_units = pd.read_excel('data/325193_process_parameters.xlsx', sheet_name= 'unit types')
myprocess_non_electrifiable_fuels = pd.read_excel('data/325193_process_parameters.xlsx', sheet_name= 'non electrifiable fuels')
...
spread_heat_df_cleaned.to_excel('output/ethanol_heat.xlsx')
